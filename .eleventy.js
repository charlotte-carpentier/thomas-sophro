...
export default function (eleventyConfig) {
  ...
  eleventyConfig.on('beforeBuild', () => {
    ...
    // Garder la trace des IDs d'images existantes
    ...
    if (fs.existsSync(boatsDir)) {
      ...
      boatFiles.forEach(file => {
        try {
          ...
          // Ignorer si pas d'images ou de carousel défini
          if (!boatData.boat_images || !boatData.carousel) {
            return;
          }
          ...
          // Traiter chaque image du bateau
