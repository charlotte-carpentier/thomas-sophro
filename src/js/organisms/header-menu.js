...
document.addEventListener('DOMContentLoaded', () => {
    ...
    if (toggleBtn && dropdown) {
        ...
        // Récupère les informations de style et taille depuis les attributs data
        const containerSize = toggleBtn.dataset.containerSize || '';
        const iconSize = toggleBtn.dataset.iconSize || '24';
        const iconStyle = toggleBtn.querySelector('span')?.className || '';
        
        // Sauvegarde l'icône burger originale
        const burgerIcon = toggleBtn.innerHTML;
        
        // Crée l'icône de croix en utilisant le même style que l'icône burger
        const closeIcon = `<span class="${iconStyle}">
            <svg xmlns="http://www.w3.org/2000/svg" width="${iconSize}" height="${iconSize}" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="18" y1="6" x2="6" y2="18"></line><line x1="6" y1="6" x2="18" y2="18"></line></svg>
        </span>`;
